    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="flex flex-col gap-16 md:flex-row">
            ...
            <div class="w-full md:w-1/2 grid grid-cols-1 gap-x-8 gap-y-6 lg:pt-2">
                ...
                <p class="text-lg leading-8 text-gray-600">Desde el año 2009 estamos en el corazón de Fuengirola, en la Costa del Sol.</p>
                <p class="text-md leading-8 text-gray-600">Av. Ramón y Cajal 10, Fuengirola, Málaga.</p>
                <p class="text-sm font-bold leading-8">Horario de atención<br>Lu - Vi 10 a 20hs | Sa 10 a 15hs.</p>
